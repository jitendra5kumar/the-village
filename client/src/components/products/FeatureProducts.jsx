  ...
  return (
    <div className="w-[95%] flex flex-wrap mx-auto">
      <div className="w-full">
        <div className="text-center flex justify-center items-center flex-col text-4xl text-[#3E2018] font-bold relative pb-[45px]">
          <div className="flex gap-5">
            <span class="title-star"> ★</span>
            <span>MOST LOVED LEGENDS </span>
      ...
      <div className="w-full grid grid-cols-5 md-lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2 gap-7">
        {products.map(
          (p, i) =>
            i < 20 && (
              <Link
