          ...
          <div className="flex w-full justify-between items-center h-[50px] text-black">
            <ul className="flex justify-start items-center gap-8">
              <li className="flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]">
                ...
                <span>info@omgeniustech.com</span>
              </li>
              <span>Om Genius Technology</span>
            </ul>
            <div>
              <div className="flex justify-center items-center gap-10">
                <div className="flex justify-center items-center gap-4">
                  <a href="https://www.facebook.com/profile.php?id=61554104745032">
                    <FaFacebookF />
                  </a>
                  <a href="#">
                    <AiOutlineTwitter />
                  </a>
                  <a href="https://www.linkedin.com/company/101336002">
                    <FaLinkedinIn />
                  </a>
                  <a href="https://www.instagram.com/om_geniustech/">
                    <AiFillInstagram />
                  </a>
                </div>
          ...
          <div className="flex justify-start flex-col gap-6">
            ...
            <div className="w-full flex justify-end md-lg:justify-start gap-3 items-center">
              ...
              <div className="flex justify-end flex-col gap-1">
                ...
                <span className="text-xs">support 24x7 time</span>
              </div>
            </div>
